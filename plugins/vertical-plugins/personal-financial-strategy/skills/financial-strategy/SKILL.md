...
4. **Washington overlay.** For any estate, capital-gains, long-term-care, or marital-property question, load `references/states/washington.md`. State-level rules are where generic national guidance fails a WA household — and WA changed both its capital-gains and estate statutes within the last 13 months.
...
| `references/states/washington.md` | WA capital-gains excise tax, WA estate tax (split-year 2026), community property, WA Cares | Any WA question on gains, estates, LTC, or marital property |
